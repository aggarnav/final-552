...
test_parseMoves =
  TestList
    [ -- Test Pawn move
      ...
      parseMoves
        "d4 g6 c4 Nf6 Nc3 Bg7 e4 O-O Bg5 d6 Nf3 Nbd7 e5 dxe5 dxe5 \
        \Ng4 Nd5 Ngxe5 Nxe7+ Kh8 Nxg6+ hxg6 Bxd8"
        ~?= Right
          [ NormalMove
              Pawn
              (Square 4 'd')
